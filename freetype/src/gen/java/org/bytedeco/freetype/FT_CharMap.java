...
import static org.bytedeco.freetype.global.freetype.*;
   ...
   *   character map.
   */
  @Name("FT_CharMapRec_") @Opaque @Properties(inherit = org.bytedeco.freetype.presets.freetype.class)
public class FT_CharMap extends Pointer {
      /** Empty constructor. Calls {@code super((Pointer)null)}. */
      public FT_CharMap() { super((Pointer)null); }
      /** Pointer cast constructor. Invokes {@link Pointer#Pointer(Pointer)}. */
      public FT_CharMap(Pointer p) { super(p); }
  }
